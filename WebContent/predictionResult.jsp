...
<head>
    ...
    <title>LOGO | 백테스트결과</title>
    <link rel="stylesheet" href="../css/common.css">
    <link rel="stylesheet" href="../css/header.css">
    <link rel="stylesheet" href="../css/footer.css">
    <link rel="stylesheet" href="../css/predictionResult.css">
</head>
<body>
    <div id="container">
    <!-- 헤더(로고 및 로그인, 네비바) -->
        ...
        <div class="main">
            <!-- 백테스트 결과 영역 -->
            <div class="betatestResult">
                <!-- 결과 차트 -->
                <div class="resultChart">
                    <!-- 결과 차트 제목 -->
                    <div class="resultChart-title">
                ...
                <div class="resultIndex">
                    <!-- 결과지표 제목 -->
                    <div class="resultIndex-title">
                        <h2>주요 성과 지표</h2>
                    </div>
                    <form class="resultTable">
                        <table>
                            <tr>
            ...
            <div class="verify-box">
                <input type="button" value="저장" onclick="openSaveMsg()">
                <input type="button" value="이전" onclick="location.href='prediction.html'">
            </div>
        </div>
