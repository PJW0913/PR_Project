...
<head>
    ...
    <link rel="stylesheet" href="css/boardEditNotice.css">
</head>
<body>
    <div id="container">
    <!-- 헤더(로고 및 로그인, 네비바) -->
            ...
            <div class="board_write">
                ...
                <div class="board_write_wrap">
                    ...
                    <div class="bottom-wrap">
                        <a href="boardViewNotice.html" class="on">수정</a>
                        <a href="boardViewNotice.html">취소</a>
                    </div>
                </div>
            </div>
        </div>
